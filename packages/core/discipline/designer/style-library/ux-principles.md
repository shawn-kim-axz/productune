# UX principles (reference — generic UX/UI craft)

Portable, project-agnostic UX/UI craft — the single generic home for design
principles; applies across every project. Each project's `docs/design.md` APPLIES
