# Anti-default — escape the AI-default look (reference)

Consult at every rendered UI design artifact — DS proposals, mockups, hi-fi —
before surfacing it to the user (bound by designer habit + playbooks). You are
