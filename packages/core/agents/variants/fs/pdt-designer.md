...
1. Consult memory: if `wiki_consult:` use it; else read `~/.productune/wiki/persona-designer/INDEX.md` → top 3 → read. Then `docs/design/*.md` + `docs/designer/*.md` + `docs/qa/fail-patterns.md` (Phase 1 only).
