...
#
# Source: docs/artifacts/v0.4/T-P4-124/plan.md §5.1 + user OQ decisions (2026-05-19)
# Designer was a subagent without Bash; this script is the executable deliverable
# for PO/user shell execution.
#
# Run from anywhere:  bash docs/artifacts/v0.4/T-P4-124/drop-mv-script.sh
# Dry-run preview:    DRY_RUN=1 bash docs/artifacts/v0.4/T-P4-124/drop-mv-script.sh
...
# To restore all 40:
#   bash docs/artifacts/v0.4/T-P4-124/drop-mv-script.sh --restore   # (not implemented;
