...
related_docs:
  ...
  - docs/tickets/phase4/ROADMAP.md (Round 2)
out_of_scope:
...
1. **T-P4-024 design plan** ← **다음 dispatch** — `git-rules.json` schema final +
   Settings sub-tab 컴포넌트 spec + IPC 시그니처. `docs/design/T-P4-024-git-rules-json-foundation.md`.
...
- 본 plan (`docs/design/R2-git-abstraction-architecture.md`) 의 §4 / §9 결정 인용.
...
- ticket 발행 (`docs/tickets/phase4/T-P4-NNN.md`) X — T-P4-020/021/022/023/024 는
