...
**Roadmap anchor**: [docs/tickets/phase4/ROADMAP.md#round-6](../tickets/phase4/ROADMAP.md) — Round 6 외부 서비스 setup 가이드의 **사전 합의 디자인**
**Tokens**: [docs/design/design-direction.md](./design-direction.md) (Pretendard / Productune Indigo / 4px grid / Lucide)
