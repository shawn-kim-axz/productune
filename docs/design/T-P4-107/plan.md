...
| `docs/design/design-system.md §1.5` | Insert footnote | After §1.5 closing sentence: "UX vocabulary splits on `userMode` (`developer`/`planner`) — tone-aware messaging doctrine: T-P4-084 (store) + T-P4-107 (PO routing)." |
