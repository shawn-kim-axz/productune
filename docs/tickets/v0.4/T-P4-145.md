...
- `docs/artifacts/v0.4/T-P4-145/plan.md` — 전체 명세 (wireframe 포함)
...
<!-- migrated from docs/artifacts/v0.4/T-P4-145/plan.md -->
...
```
┌──────────────────────────────────────────────────┐
│  v0.4                           ›   │  ← id (orange, bold) + ChevronRight (right-aligned, muted)
│  Phase  Plan (2/5)                                │
│  3 tickets                                        │
...
| 2026-05-20T09:50Z | pdt-developer | sonnet/medium | 2 | impl done — Bug 1b/2/5 + Bug 6 (위키 sub-row 제거 user Q3 override); 528 keys |
