...
- `docs/artifacts/v0.4/T-P4-149/plan.md` — 전체 명세 (변경 diff 포함)
...
<!-- migrated from docs/artifacts/v0.4/T-P4-149/plan.md -->
...
| 2026-05-21T00:00Z | pdt-designer | sonnet/medium | 2 | impl done — delegation.md "Session lifecycle (T-P4-149)" + lifecycle.md archive jq; mirror sync clean |
