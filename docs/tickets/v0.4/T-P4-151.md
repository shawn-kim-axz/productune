...
Full text inserts specified in `docs/artifacts/v0.4/T-P4-151/plan.md`.
...
- `docs/artifacts/v0.4/T-P4-151/plan.md` — full specification (exact insert text, file list)
...
<!-- migrated from docs/artifacts/v0.4/T-P4-151/plan.md -->
