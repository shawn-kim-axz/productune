...
```json
{
  ...
  "changed_files": [
    ...
    "docs/artifacts/v0.4/T-P4-112/plan.md"
  ],
  "confidence": "high"
}
```
...
<!-- migrated from docs/artifacts/v0.4/T-P4-112/plan.md -->
...
- design 산출물 (`.md` docs/artifacts/) + code 파일 (`.tsx`, `.ts`, `.json`) 모두 포함.
...
│  (MarkdownTab — docs/artifacts/v0.4/T-P4-112/plan.md)              │
│                                                             │
└─────────────────────────────────────────────────────────────┘
