...
v0.4 dogfood 중 paepyeong 프로젝트에서 PO 실행 시 `~/.productune/po-instructions.md` 부재로 doctrine 강제 실패. 사용자 직접 디버깅 (2026-05-14) 으로 원인 확인.
...
<!-- migrated from docs/artifacts/v0.4/T-P4-109/plan.md -->
