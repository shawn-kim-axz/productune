...
| 시나리오 | 현재 사용자 행동 | 문제 |
|:--|:--|:--|
| `docs/artifacts/v0.4/T-P4-114/plan.md` 언급 | Quick Open 또는 FileTree 수동 클릭 | 컨텍스트 전환 마찰 |
...
| 조건 | open 탭 type |
|:--|:--|
| `docs/artifacts/**/*.md` 또는 `docs/tickets/**/*.md` | `markdown` |
| `docs/qa/**/*.md` | `markdown` |
...
| **사용자 dogfood** | ① PO chat 에 `T-P4-113` bare mention → 보라 링크 등장 → click → ticket-review tab open 확인. ② PO chat 에 `docs/artifacts/v0.4/T-P4-114/plan.md` mention → 파란 링크 → click → markdown tab open. ③ PO chat 에 `https://vercel.com` mention → 회색 링크 → click → browser tab + webview 로드. ④ 실제 PO dispatch (ticket emit) → ticket detail tab 자동 open + main pane focus 이동. ⑤ 기존 마크다운 bold / code / list 회귀 없음. |
...
- Plan: `docs/artifacts/v0.4/T-P4-114/plan.md`
...
<!-- migrated from docs/artifacts/v0.4/T-P4-114/plan.md -->
...
│  │                                                      │  │
│  │  산출물:                                             │  │
│  │  [docs/artifacts/v0.4/T-P4-114/plan.md]                     │  │
