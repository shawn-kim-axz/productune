...
- ROADMAP open question close: T-P4-022 squash vs merge → squash (`docs/tickets/v0.4/ROADMAP.md` Open questions)
...
ticket md (`docs/tickets/v0.4/T-P4-022.md`) 의 acceptance 보강 source. 별
...
3. ticket md (`docs/tickets/v0.4/T-P4-022.md`) acceptance 보강 — 본 plan §15
