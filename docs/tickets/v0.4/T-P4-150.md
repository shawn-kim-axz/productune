...
Ref: `docs/artifacts/v0.4/T-P4-150/plan.md` §Acceptance (A1–A9).
...
- `docs/artifacts/v0.4/T-P4-150/plan.md` — full specification (exact insert text, file list)
...
<!-- migrated from docs/artifacts/v0.4/T-P4-150/plan.md -->
...
{ "persona":"pdt-designer", "session_id":"<uuid>",
  "design_doc_path":"docs/artifacts/<feature>.md", "summary":"2–4 sentences",
```
...
| 2026-05-21T00:00Z | pdt-designer | sonnet/medium | 2 | impl done — 9 variant + 3 doctrine + 3 mirror sync; summary/user_surface field 신규 |
